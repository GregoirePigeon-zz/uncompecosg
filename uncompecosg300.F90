!file uncompressecosg300.F90
SUBROUTINE UNCOMPECOSG300( FILEIN, FILEOUT)
!adapted from uncompress_file_300m0.F90 provided by Ecoclimap sg project
!read original compressed ecoclimap sg binary file '_c' in name
!write uncompressed ecoclimap sg file
IMPLICIT NONE

!arguments
!f2py intent(in) :: FILEIN, FILEOUT
!local variables
...
open(13,file = FILEOUT,form='unformatted',access='direct',recl=ncol*3)
